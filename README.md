...
Ticker timer3(printCountdown, 1000, 5); // 5 times, every 1000 microsecond
Ticker timer4(blink, 500); // changing led every 1000 microsecond
Ticker timer5(printCountUS, 100, 0, MICROS_MICROS); // the interval time is 1000 microsecond and the internal resolution is micro seconds
...
```cpp
Tickers timer(blink, 1000); // calls function blink() every 1000 microsecond, internal resolution is micros, running endless
Tickers timer(blink, 1000, 5); // calls function blink() every 1000 microsecond, internal resolution is micros, only 5 repeats
